...
import com.example.techstore.repository.InventarioRepository;
...
class InventarioServiceTest {
    ...
    @Test
    @DisplayName("actualizarInventario() debe permitir cambiar la ubicacion de forma independiente")
    void actualizarInventario_soloUbicacion_actualizaCorrectamente() {

        Inventario cambios = new Inventario();
        cambios.setUbicacion("Bodega B - Estante 1");
        ...
        assertEquals("Bodega B - Estante 1", resultado.getUbicacion());
        assertEquals(50, resultado.getStock(), "El stock no debe cambiar");
    }
