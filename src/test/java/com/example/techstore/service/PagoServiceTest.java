...
class PagoServiceTest {
    ...
    @Test
    @DisplayName("actualizar() debe actualizar el monto sin modificar el método de pago")
    void actualizar_soloMonto_actualizaCorrectamente() {
        
        Pago cambios = new Pago();
        cambios.setMonto(250000);
        ...
        assertEquals(250000, resultado.getMonto());
        assertEquals("Transferencia bancaria", resultado.getMetodoPago(),
                "El método de pago no debe cambiar");
    }
